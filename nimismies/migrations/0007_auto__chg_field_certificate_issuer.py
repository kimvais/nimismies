...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Certificate.issuer'
        db.alter_column(u'nimismies_certificate', 'issuer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nimismies.Certificate'], null=True))

    def backwards(self, orm):

        # Changing field 'Certificate.issuer'
        db.alter_column(u'nimismies_certificate', 'issuer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['nimismies.Certificate']))
